...
## Project Structure
    ...
    ├── twenty_three_hour_h_37939  # Django project configurations
...
1. Clone this repo and `cd twenty_three_hour_h_37939`
...
2. Clone this repo and `cd twenty_three_hour_h_37939`
